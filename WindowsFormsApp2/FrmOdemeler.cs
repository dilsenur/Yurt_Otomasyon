...
namespace WindowsFormsApp2
{
    public partial class FrmOdemeler : Form
    {
        ...
        private void BtnOdemeAl_Click(object sender, EventArgs e)
        {
            ...
            //Kasa Tanlosuna Ekleme Yapma
            SqlCommand komut2 = new SqlCommand("insert into Kasa (OgrenciAd,OgrenciSoyad,OdemeAy,OdemeMiktar) values (@k1,@k2,@k3,@k4)",bgl.baglanti());
            komut2.Parameters.AddWithValue("@k1",TxtAd.Text);
            komut2.Parameters.AddWithValue("@k2",TxtSoyad.Text);
            komut2.Parameters.AddWithValue("@k3",mskOdenenAy.Text);
            komut2.Parameters.AddWithValue("@k4",TxtOdenen.Text);
