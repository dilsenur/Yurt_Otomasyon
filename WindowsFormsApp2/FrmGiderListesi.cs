...
namespace WindowsFormsApp2
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'yurtOtomasyonuDataSet4.YurtGiderler' table. You can move, or remove it, as needed.
            this.yurtGiderlerTableAdapter.Fill(this.yurtOtomasyonuDataSet4.YurtGiderler);
        ...
        {
            int secilen;
            FormGiderGüncelleme frg = new FormGiderGüncelleme();
            ...
            frg.elektirik = dataGridView1.Rows[secilen].Cells[2].Value.ToString();
            ...
            frg.temizlik = dataGridView1.Rows[secilen].Cells[7].Value.ToString();
